...
public:
	...
	void Init(bool isSubmachine = false, uint16_t intialialTimerPeriodIfAny = 1,
...
template<TemplateFor_SimpleFSM_NoDefaults>
inline void AESimpleFSM<TemplateFor_SimpleFSM_Args>::Init(bool isSubmachine, uint16_t intialialTimerPeriodIfAny, TSubMachine1 * subMachine1, TSubMachine2 * subMachine2, TSubMachine3 * subMachine3)
{
	...
	}, "GaurdTaskToExecuteForEvt", configMINIMAL_STACK_SIZE, this, AOPRIORITYMEDIUM, &GaurdTaskToExecuteForEvtHandle);
...
inline bool AESimpleFSM<TemplateFor_SimpleFSM_Args>::DoAnySubmachinesSubscribeToEvent(EventPoolSize_t evtId)
{
	...
	return MyActivatedSubmachines->ForEachIsAnyTrueWithItem(evtId, [](uint16_t evtIDarg, uint16_t submachineAOId) {
