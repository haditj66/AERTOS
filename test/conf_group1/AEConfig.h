...
#define GPIOPERIPHERAL1_Name GpioLed1

#define GPIOPERIPHERAL2 GPIOPeripheral<PortD, PIN14>

#define GPIOPERIPHERAL2_Name GpioLed2

#define GPIOPERIPHERAL3 GPIOPeripheral<PortD, PIN15>

#define GPIOPERIPHERAL3_Name GpioLed3


//gpio inputs
#define GPIOInputPERIPHERAL1 GPIOInputPeripheral<PortD, PIN0>

#define GPIOInputPERIPHERAL1_Name Gpiobutton1 

#define GPIOInputPERIPHERAL2 GPIOInputPeripheral<PortD, PIN2>

#define GPIOInputPERIPHERAL2_Name Gpiobutton2


//adc
//template<uint16_t WhichInstanceOfADC, Portenum ADC_ch1_Port, PinEnum ADC_ch1_Pin, Portenum ADC_ch2_Port, PinEnum ADC_ch2_Pin, Portenum ADC_ch3_Port, PinEnum ADC_ch3_Pin, Portenum ADC_ch4_Port, PinEnum ADC_ch4_Pin, Portenum ADC_ch5_Port, PinEnum ADC_ch5_Pin>
//class ADCPeripheral;

#define ADCPERIPHERAL1 ADCPeripheral<1,PortB, PIN0, PortA, PIN2, PortA, PIN3> 
#define ADCPERIPHERAL1_Name_CH1 adc1
#define ADCPERIPHERAL1_Name_CH2 adc2
