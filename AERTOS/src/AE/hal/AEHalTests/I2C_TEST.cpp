//generated file: C:/AERTOS/AERTOS/src/AE/hal/AEHalTests\I2C_TEST.cpp
//**********************************************************************
...
#if INTEGRATION_TESTS_FOR_AEHalTests__I2C_TEST
...
#define WAIT_UNTIL_I2C_READY while (HAL_I2C_GetState(I2CPERIPHERAL_inst1->_i2c_Handle) != HAL_I2C_STATE_READY) {}
#else 
...
AE_Init();
 //UserCode_Sectionbeforemain
	...
	AEITEST_EXPECT_TEST_TO_RUN_AEHalTests("i2c_returned")
...
//			while (HAL_I2C_GetState(&hi2c1) != HAL_I2C_STATE_READY) ;
	...
	//	extern "C" void FLASH_IRQHandler();
		...
		I2CPERIPHERAL_inst1->ReadBytes(0x68, 1, nullptr);
		WAIT_UNTIL_I2C_READY
		uint8_t  secondHalf = I2CPERIPHERAL_inst1->GetI2CBuffer()[0];
...
#ifdef  SWIL_HWIL_DRIVEN__HWIL
	AEITEST_AEHalTests_MUST_PASS_THIS_MANY("i2c_returned", az > 10000, "mpu returned data with az greater than 10000", 18)
#else 
	AEITEST_AEHalTests_MUST_PASS_THIS_MANY("i2c_returned", az == 0, "mpu returned data with az greater than 10000", 18)
#endif 
