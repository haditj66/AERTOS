...
//	-then git commit everything and maybe tag it as a working point!
//	-migrate this project over to the new computer!
//	- change the build folder to make it dependent on the integration exe target location (as well as the cgencmakecache.cmake file).
//	-start on the spi peripheral.	
//	-Time to refactor everything down! First things first is to turn TDU and action requests into AOs.
