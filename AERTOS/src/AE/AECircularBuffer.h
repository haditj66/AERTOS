...
//class AEICircularBuffer
//{
//public: void virtual SetMutex(xSemaphoreHandle mutex) = 0;
//	
//};
//
...
template<class ContainerType, uint16_t MaxSize>
	class AECircularBuffer// : AEICircularBuffer
	{
	public: 
...
//		void  SetMutex(xSemaphoreHandle mutex) override
//		{
//			MutexForThisCircularBuffer = mutex;
//		}
		...
		const ContainerType* GetBufferAddress() const
		{
			return buffer;
		}
...
template<class ContainerType, uint16_t MaxSize>
	...
	{
//		AllCircularBuffs[AllCircularBuffsInd] = this;
//		AllCircularBuffsInd++;
